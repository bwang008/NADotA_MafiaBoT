...
def LoginBot():
	...
	time.sleep(1)
	####username####
	driver.find_element_by_xpath("""//*[@id="navbar_username"]""").send_keys("StoveBot.Mafia")
	driver.find_element_by_xpath("""//*[@id="navbar_password_hint"]""").click()
	####password####
	driver.find_element_by_xpath("""//*[@id="navbar_password"]""").send_keys('12345')
	driver.find_element_by_xpath("""//*[@id="cb_cookieuser_navbar"]""").click()
	time.sleep(1)
	driver.find_element_by_xpath("""//*[@id="logindetails"]/div/div/input[4]""").click()
...
driver.get("http://nadota.com/forumdisplay.php?34-Mafia")
#################################################################
####################GAME URL GOES HERE ##########################
#################################################################
